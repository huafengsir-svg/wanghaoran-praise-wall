...
<body>
  ...
  <main class="container">
    ...
    <div class="load-more" id="load-more" style="display:none;">
      ...
      <div class="count" id="load-more-count"></div>
    </div>
  </main>
  ...
  <script>
    ...
    function renderPage() {{
      ...
      const pageReviews = visibleReviews.slice(0, end);
      wall.innerHTML = '';
      pageReviews.forEach((r, i) => wall.appendChild(createCard(r, i)));
    ...
    function updateLoadMoreButton() {{
      ...
      const shown = Math.min(currentPage * PAGE_SIZE, visibleReviews.length);
      ...
      if (shown >= total) {{
        ...
        count.textContent = `已显示 ${{shown}} / ${{total}} 条`;
      }}
    }}
